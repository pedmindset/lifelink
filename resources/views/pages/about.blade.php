   ...
   <body class="antialiased w-full h-full bg-gray-50">
      ...
      <main>
         <div class="relative bg-gray-900">
            ...
            <div class="relative max-w-5xl mx-auto py-28 px-6 flex flex-col sm:items-start sm:text-start sm:pt-64 sm:pb-32 lg:px-0">
               <h1 class="text-4xl text-center sm:text-left font-extrabold tracking-tight text-white lg:text-6xl">About us</h1>
               <p class="mt-4 text-2xl text-center sm:text-left text-green-400 py-6">Life-Link Friendship Schools</p>

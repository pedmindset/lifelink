<x-guest-layout>
   <x-auth-card>
      ...
      <div class="bg-gray-100 p-8 text-gray-500 rounded-xl shadow-xl w-full overflow-hidden">
         <div class="md:flex w-full md:max-w-4xl">
            ...
            <div class="w-full py-10 px-5 md:px-10">
               <div class="text-center mb-10">
                  <h1 class="font-bold text-3xl text-indigo-900 uppercase">register</h1>
                  <p class="text-xs font-sans text-gray-500 leading-6 tracking-widest">Create a new account</p>
               </div>
               ...
               <form method="POST" class="max-w-4xl w-full md:w-96" action="{{ route('register') }}">
                  @csrf
                  <div class="flex -mx-3">
                     <div class="w-full px-3 mb-3">
                        <label for="first-name" class="text-xs font-semibold px-1">First Name</label>
                        <div class="flex">
                  ...
                  <div class="flex -mx-3">
                     <div class="w-full px-3 mb-3">
                        <label for="last-name" class="text-xs font-semibold px-1">Last Name</label>
                        <div class="flex">
                           <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  ...
                  <div class="flex items-center justify-center my-8">
                     ...
                     {{ __("Already registered?") }} <span class="font-bold text-cyan-600 hover:text-indigo-500"> <a href="{{ route('login') }}">{{ _('Login') }}</a></span>
                     </p>
                  </div>

<x-guest-layout>
   <x-auth-card>
      ...
      <div class="bg-gray-100 text-gray-500 p-8 rounded-xl shadow-xl w-full overflow-hidden">
         <div class="md:flex w-full">
            ...
            <div class="w-full py-10 px-5 md:px-10">
               <div class="text-center mb-10">
                  <h1 class="font-bold text-3xl text-indigo-900 uppercase">login</h1>
                  <p class="text-xs font-sans text-gray-500 leading-6 tracking-widest">Login to Life Link Ghana</p>
               </div>

               <x-auth-session-status class="mb-4" :status="session('status')" />

               <x-auth-validation-errors class="mb-4 bg-red-100 py-2 px-3 rounded-md shadow-inner" :errors="$errors" />
                  ...
                  <div class="flex -mx-3">
                     <div class="w-full px-3 mb-5">
                        ...
                        <div class="flex">
                           ...
                           <input type="email" name="email" required class="w-full transition-all ease-linear duration-300 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="flex -mx-3">
                     <div class="w-full px-3 mb-5">
                        ...
                        <div class="flex">
                           ...
                           <input type="password" name="password" required autocomplete="current-password" class="w-full transition-all ease-linear duration-300 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                        </div>
                     </div>
                  </div>

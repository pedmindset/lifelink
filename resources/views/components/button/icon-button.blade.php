...
<button x-on:click="editItem(item)" class="inline-flex rounded-md p-1 text-gray-500 hover:bg-green-100 hover:text-green-500 focus:outline-none focus:bg-green-100 transition ease-in-out duration-150">
   <i class="font-bold text-2xl las la-edit"></i>
</button>

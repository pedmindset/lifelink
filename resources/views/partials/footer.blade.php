<footer class="bg-gray-50" aria-labelledby="footer-heading">
   <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <div class="mt-8 flex justify-center space-x-6">
         <a href="https://www.facebook.com/LFGhana/" class="text-gray-400 hover:text-gray-500">
         ...
         <a href="https://instagram.com/lifelinkgh" class="text-gray-400 hover:text-gray-500">
         ...
         <a href="https://twitter.com/lifelinkghana" class="text-gray-400 hover:text-gray-500">

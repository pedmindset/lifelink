                              ...
                              <div class="my-3">
                                 <ul class="flex space-x-2">
                                    ...
                                    <li class="inline-flex items-center py-0.5 px-3 hover:bg-green-300 rounded-full text-xs font-medium bg-indigo-100 text-indigo-700">
                                       {{ $s['fieldName'] }}
                                       <button wire:click="removeField({{ $s['id'] }})" type="button" class="flex-shrink-0 ml-0.5 h-4 w-8 rounded-full inline-flex items-center justify-center text-indigo-400 hover:bg-indigo-200 hover:text-indigo-500 focus:outline-none focus:bg-indigo-500 focus:text-white">

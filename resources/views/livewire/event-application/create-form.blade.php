<div class="fixed inset-0 overflow-hidden z-20" x-data="{ openOptions: @entangle('optionMode') }" x-show="openCreateForm" style="display:none"
         ...
         <div class="w-screen max-w-6xl"
            ...
            <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
                           ...
                           <div class="">
                              <div class="my-3">
                                 <ul class="flex space-x-2">
                                    @foreach ($schema as $s)
                                    <li class="inline-flex items-center py-0.5 px-3 hover:bg-green-300 rounded-full text-xs font-medium bg-indigo-100 text-indigo-700">
                                       {{ $s['fieldName'] }}
               ...
               <div class="flex-shrink-0 px-4 py-4 flex justify-end bg-gray-200 shadow-inner">
                  <button type="button" @click="openCreateForm = false" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                     Cancel
                  </button>

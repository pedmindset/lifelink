                     ...
                     <p class="text-sm text-gray-500">
                        ...
                        <div x-data="{ open:false }">
                           ...
                           <div class="relative mt-1">
                              <input @click="open = !open" wire:model.lazy="selectedClientName" readonly placeholder="Select applicant" wire:change="searchClient($event.target.value)" class="w-full rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" id="headlessui-combobox-input-2" role="combobox" type="text" aria-expanded="true" aria-labelledby="headlessui-combobox-label-1" aria-controls="headlessui-combobox-options-30">

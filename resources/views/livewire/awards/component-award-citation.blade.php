   ...
   <div class="py-10">
      <div class="max-w-full sm:px-6 lg:px-8">
         ...
         <div class="flex place-content-end mb-4">
            <div class="px-4 py-2 text-white bg-indigo-600 hover:bg-indigo-700 cursor-pointer rounded-tr-md rounded-bl-md">
               <button type="button" class="text-sm font-medium">New Award/Citation</button>
            </div>
         </div>
         ...
         <table class="min-w-full border divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200 divide-solid w-full">
               ...
               <tr class="bg-white w-full">
                  ...
                  <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                     <span class="items-center flex justify-center">Participation Award</span>
                  </td>
                  <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                     <span class="items-center flex justify-center">MMDC Opening</span>
                  </td>
                  <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                     <span class="items-center flex justify-center">12th January, 2022</span>
                  </td>
                  <td class="space-x-2">
         ...
         <div class="w-3/4 mx-auto text-center py-8 bg-white shadow my-8 border-t-4 border-r-4 border-gray-400 rounded-t-lg">
            ...
            <p class="mt-6 mb-10"><span class="px-4 py-2 text-sm rounded-md text-white w-auto bg-indigo-600 hover:bg-indigo-700 cursor-pointer"> <i class="las la-plus text-md px-1"></i> New Award/Citation </span></p>
         </div>

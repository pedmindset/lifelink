                     ...
                     <div class="h-full" aria-hidden="true">
                        <div class="space-y-3 pb-5">
                           ...
                           <div>
                              ...
                              <div class="mt-1">
                                 <select wire:model.lazy="event" id="event" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base capitalize border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">

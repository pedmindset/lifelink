...
<div class="bg-gray-100 z-10" style="min-height: 320px;">
  ...
  <div x-data="{ show: @entangle('access_denied') }" aria-live="assertive" class="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start mt-16">

<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" style="display:none" x-show="openDelete" role="dialog" aria-modal="true">
            ...
            <div class="sm:flex sm:items-start">
               ...
               <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div class="mt-2">
                     ...
                     Are you sure you want to deactivate this account? All of your data will be permanently removed. This action cannot be undone.
                     </p>
                  </div>
               </div>
            </div>
